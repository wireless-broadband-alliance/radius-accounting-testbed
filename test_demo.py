...
class TestAttributeChecks:
    def test_unique_persistent_acct_session_id(self, testdata):
    ...
    def test_acct_session_id_auth_acct(self, testdata):
    ...
    def test_start_update_stop_present(self, testdata):
    ...
    def test_stop_record_last_message(self, testdata):
    ...
    def test_stop_record_highest_usage(self, testdata):
    ...
    def test_at_least_three_class_echoed(self, testdata):
    ...
    def test_cui_echoed(self, testdata):
    ...
    def test_in_gigaword_rolls_over(self, testdata):
    ...
    def test_out_gigaword_rolls_over(self, testdata):
...
class TestAccuracyChecks:
    ...
    def test_input_tonnage_accuracy(self, testdata):
        """Input tonnage is accurate."""
        packets, metadata = testdata
    ...
    def test_output_tonnage_accuracy(self, testdata):
    ...
    def test_session_duration_accuracy(self, testdata):
        """Session duration is accurate."""
        tolerance = 0.05
        packets, metadata = testdata
        duration = metadata["session_duration"]
        session_time_lower_bound = duration * (1 - tolerance)
        session_time_upper_bound = duration * (1 + tolerance)
        packet = self.__get_stop_or_update_packets(packets)
    ...
    def test_input_packet_count_nonzero(self, testdata):
    ...
    def test_output_packet_count_nonzero(self, testdata):
